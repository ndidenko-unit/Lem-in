...
static void ft_create_next_queue(t_road *start_queue, t_road **end_queue, t_roomlist *tmp)
{
    int			i;
    t_road  *new_road;
...
static void ft_next_queue(t_roomlist *head, t_roomlist *tmp, t_road *start_queue)
{
    t_road *end_queue;
